...
class LocationService {
  ...
  Future<void> sendPoint({
    ...
    if (permission == LocationPermission.denied ||
      ...
      throw ApiFailure(
          'A localização é necessária apenas para registrar esta atividade de campo. Você pode habilitá-la nas configurações do dispositivo.');
    }
    if (!await Geolocator.isLocationServiceEnabled()) {
      throw ApiFailure(
          'Ative os serviços de localização do dispositivo para registrar este ponto.');
    }
